...
class MovieList extends Component {
  ...
  render() {
    const { data, isReady, hasError, error } = this.state;
    ...
    <div className="movie-card-container">
      <div className="movie-card-info">
        ...
        <div className="movie-card-details">
          <p>
            Entrada: <span>${parseFloat(movie.ticketPrice).toFixed(2)}</span>
          </p>
          <p>
            Duración: <span>{movie.duration} min.</span>
          </p>
          <p>
...
const LoadingComponent = () => (
  <>
    <p>Cargando ...</p>
    <img
      src="https://media2.giphy.com/media/xTk9ZvMnbIiIew7IpW/giphy.gif"
      alt=""
    />
  </>
);
